...
/// The modal behind the (i) on the profile.
Future<void> showPointsSheet(BuildContext context) {
  const entries = [
    (
      "What you've bought",
      'Each completed order, weighted by order value.',
    ),
    (
      "How you've engaged",
      'Reviews, comments, forum posts, chatroom activity.',
    ),
    ("What you've sold", 'Fulfilled orders and on-time shipping.'),
  ];
                  ...
                  child: Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: PointsDiamond(color: c.accent, size: 10),
                      ),
              ...
              Container(
                ...
                child: Text.rich(
                  TextSpan(
                    ...
                    children: const [
                      TextSpan(
                        text: "Points don't do anything yet.",
                        style: TextStyle(fontWeight: FontWeight.w800),
                      ),
                      TextSpan(
                        text:
                            " They're a score, not a currency — no discounts, "
                            "no tiers, no expiry. We'll tell you before that "
                            'changes.',
                      ),
                    ],
                  ),

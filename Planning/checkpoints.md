...
- [ ] **CP-A3 Seller claim code → seller surfaces appear without a restart.** *(built 2026-09-05; ready to test — claim code LBM-TEST-0001 for vendor "Snowboard Vendor", bound to grace-s+seller1@; the vendorClaims document is in the "Grace does" step)*

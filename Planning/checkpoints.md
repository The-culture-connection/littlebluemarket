...
- [ ] **CP-P3 First production deploy.** `scripts\deploy-prod.ps1`: test-all → functions, rules, indexes, Storage rules to prod → webhooks registered on the real shop → `doctor:prod`. *Claude ran it on 2026-09-08; see the status note below for how far it got.*
